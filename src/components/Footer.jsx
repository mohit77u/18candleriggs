            ...
            <div className="hidden lg:flex justify-between items-center sm:px-8">
                ...
                <div className="menu">
                    <ul className="flex items-center justify-center gap-x-8">
                        <li>
                            <Link href="/" className="block text-[16px] py-2 pl-3 pr-4 text-white rounded md:bg-transparent md:p-0 md:hover:text-blue-700">Home</Link>
                        </li>
                        <li>
                            <a href="#" className="block text-[16px] py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">What’s on</a>
                        </li>
                        <li>
                            <Link href="/book-venue" className="block text-[16px] py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Book Venue</Link>
                        </li>
                        <li>
                            <a href="#" className="block text-[16px] py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Menu</a>
                        </li>
                        <li>
                            <Link href="/gallery" className="block text-[16px] py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Gallery</Link>
                        </li>
                    </ul>
                </div>
